...
$sql_agendar = "INSERT INTO agendamentos (barbeiro_idbarbeiro, cliente_idcliente, servico_idservico, data, hora_inicio, hora_fim)
...
$stmt->bind_param("iiisss", $barbeiro_id, $cliente_id, $servico_id, $data_atual, $hora_inicio, $hora_inicio);
